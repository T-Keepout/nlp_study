...
def classify_one(
    text: str, model, tokenizer, device: torch.device, max_new_tokens: int = 8
) -> str:
...
def main():
    ...
    parser.add_argument(
        "--num_samples", default=200, type=int, help="从验证集随机采样的样本数"
    )
    parser.add_argument("--seed", default=42, type=int)
    parser.add_argument("--demo", action="store_true", help="只跑 5 条示例（快速演示）")
